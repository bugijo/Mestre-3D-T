        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-3 gap-4 mt-12 max-w-2xl mx-auto">
            ...
            <div class="glass-panel p-4">
              ...
              <div class="text-sm text-textSecondary mt-2">Web OK</div>
            </div>
          </div>
          ...
          <div class="glass-panel p-6 mt-8 text-left">
            ...
            <div class="space-y-3 text-textSecondary">
              ...
              <div class="flex items-center gap-3">
                <span class="text-2xl">✅</span>
                <div>
                  <span class="text-manaBlue font-semibold">Versão Web:</span> Rodando com Tailwind CDN (sem npm)
                </div>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-2xl">✅</span>
          ...
          <div class="glass-panel p-6 mt-8">
            <h3 class="text-xl font-bold text-textPrimary mb-4">🎨 Paleta de Cores:</h3>
            <div class="grid grid-cols-5 gap-3">
              <div class="text-center">
                <div class="w-12 h-12 rounded-lg bg-strengthRed mx-auto mb-2"></div>
                <div class="text-xs text-textSecondary">Força</div>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 rounded-lg bg-skillBlue mx-auto mb-2"></div>
                <div class="text-xs text-textSecondary">Habilidade</div>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 rounded-lg bg-resistanceGreen mx-auto mb-2"></div>
                <div class="text-xs text-textSecondary">Resistência</div>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 rounded-lg bg-armorOrange mx-auto mb-2"></div>
                <div class="text-xs text-textSecondary">Armadura</div>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 rounded-lg bg-firepowerPurple mx-auto mb-2"></div>
